...
#### <span style="color:red">python 패키지를 고를 때는 많이 알려진 것들 위주로 설치! 최근 들어 트로이목마 패키지(개인정보 유출)가 많이 등장함.</span>.
#### <span style="color:red">R 패키지는 위의 문제가 없음. R의 정식 저장소(CRAN repository)에서만 다운로드 받아 설치하면 문제없음.</span>.
